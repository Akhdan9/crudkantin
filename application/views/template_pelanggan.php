            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a href="<?= base_url('index.php/dashboard_pelanggan')?>"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
                        <li><a href="<?= base_url('index.php/trans')?>"><i class="notika-icon notika-form"></i> Pesanan</a>
                        </li>
